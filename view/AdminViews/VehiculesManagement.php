...
class VehiculesManagement
{
                        ...
                        <tr>
                            ...
                            <td class="d-flex pl-3  ">
                                <a href="/vscar/admin/vehicules?vehiculeId=<?= $vehicule["ID_Véhicule"]; ?>"
                                    ...
                                    details</a>
                                <a href="/vscar/admin/brans?brandId=<?= $vehicule["ID_Marque"]; ?>"
    ...
    public function displayAdminVehiculeContent($vehiculeId)
    {
        ...
        ?>
            <div class="d-flex align-items-center justify-content-center">
                <form class="container bg-light p-4 rounded" action="/vscar/api/vehicule/updateVehicule.php" method="POST">
                    <input hidden value="<?php echo $vehiculeData['ID_Véhicule']; ?>" name="ID_Véhicule">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="form-label" for="Nom">Name</label>
                            <input value="<?php echo $vehiculeData['Nom']; ?>" class="form-control" type="text" name="Nom"
                                required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="marque">Brand</label>
                            <input value="<?php echo $marqueController->getMarqueNameByID($vehiculeData["ID_Marque"]); ?>"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="form-label" for="Modèle">Model</label>
                            <input value="<?php echo $vehiculeData['Modèle']; ?>" readonly class="form-control" type="text"
                                name="Modèle" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="Version">Version</label>
                            <input value="<?php echo $vehiculeData['Version']; ?>" readonly class="form-control" type="text"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="form-label" for="Année">Year</label>
                            <input value="<?php echo $vehiculeData['Année']; ?>" readonly class="form-control" type="number"
                                name="Année" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="Prix">Price</label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="form-label" for="type_carburant">Fuel type</label>
                            <input value="<?php echo $vehiculeData['type_carburant']; ?>" class="form-control" type="text"
                                name="type_carburant" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="puissance">Performance</label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="form-label" for="acceleration">Acceleration</label>
                            <div class="input-group">
                                <input value="<?php echo $vehiculeData['acceleration']; ?>" class="form-control" type="number"
                                    name="acceleration" required>
                                <span class="input-group-text">s</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="form-label" for="longueur">Length</label>
                            <div class="input-group">
                                <input value="<?php echo $vehiculeData['longueur']; ?>" class="form-control" type="number"
                                    name="longueur" required>
                                <span class="input-group-text">cm</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="largeur">Width</label>
                            <div class="input-group">
                                <input value="<?php echo $vehiculeData['largeur']; ?>" class="form-control" type="number"
                                    name="largeur" required>
                                <span class="input-group-text">cm</span>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="form-label" for="hauteur">Height</label>
                            <div class="input-group">
                                <input value="<?php echo $vehiculeData['hauteur']; ?>" class="form-control" type="number"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="form-label" for="volume_coffre">Trunk Volume</label>
                            <div class="input-group">
                                <input value="<?php echo $vehiculeData['volume_coffre']; ?>" class="form-control" type="number"
                                    name="volume_coffre" required>
                                <span class="input-group-text">L</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="moteur">Engine</label>
                            <input value="<?php echo $vehiculeData['moteur']; ?>" class="form-control" type="text" name="moteur"
                                required>
                        </div>
                    </div>
